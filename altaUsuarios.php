				...
				<form class="needs-validation">
					...
					<div class="form-row">
						<div class="form-group col-10">
							...
							<input type="text" class="form-control" id="aMaterno" name="aMaterno" placeholder="Direccion" required>
					...
					<div class="form-row">
						...
						<div class="form-group col-4">
							...
							<input type="password" class="form-control" id="contrasenia" name="contrasenia"  placeholder="Contrase&ntilde;a" required>
					...
					<div class="form-check col-6">
						<input class="form-check-input" type="radio" name="tipoUsuario" id="uVentas" value="ventas" checked>
						<label class="form-check-label" for="uVentas">
						Usuario de ventas
						</label>
					</div>
					<div class="form-check">
						<input class="form-check-input" type="radio" name="tipoUsuario" id="uAdministrador" value="administrador">
